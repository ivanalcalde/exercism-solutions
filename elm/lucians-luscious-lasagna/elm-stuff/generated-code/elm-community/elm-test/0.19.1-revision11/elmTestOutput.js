...
var $author$project$LuciansLusciousLasagna$elapsedTimeInMinutes = F2(
	function (layers, minutesInOven) {
		return $author$project$LuciansLusciousLasagna$preparationTimeInMinutes(layers) + minutesInOven;
	});
...
var pipeFilename = "/tmp/elm_test-90127.sock";
var net = require('net'),
